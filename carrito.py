...
window = tk.Tk()
window.title("Seguidor de Línea con Pista en Forma de L")
canvas = tk.Canvas(window, width=800, height=600)
canvas.pack()

# Definir paradas para formar una pista en forma de L
stops = [(150, 100),   # parada 1: esquina superior izquierda
         (650, 100),   # parada 2: esquina superior derecha
         (650, 300),   # parada 3: punto medio-derecha
         (150, 300),   # parada 4: punto medio-izquierda
         (150, 500)]   # parada 5: esquina inferior izquierda
...
# Crear barra de parada en S5
s5_x, s5_y = stops[4]  # Posición de S5
stop_bar = canvas.create_rectangle(s5_x-40, s5_y-5, s5_x+40, s5_y+5, 
                                 fill='black', outline='red', width=2)

# Inicializar carro
car = LineFollowerCar(canvas)
canvas.create_text(400, 30, text="Seguidor de Línea - Pista en Forma de L", font=("Arial",14,"bold"))
