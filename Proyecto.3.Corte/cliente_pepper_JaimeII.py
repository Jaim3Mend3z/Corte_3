...
tts.say("Hola, soy ChatSimó atravez del cuerpo valioso de Pepper, estoy aqui para servir como tu asistente sarcástico de Linux. Si te digo algo cruel, es por tu bien ;)")
